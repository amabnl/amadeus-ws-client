...
class ClientTest extends BaseTestCase
{
    ...
    public function testCanDoTicketDeleteTSMP()
    {
        ...
        $mockSessionHandler
            ->expects($this->once())
            ->method('sendMessage')
            ->with('Ticket_DeleteTSMP', $expectedMessageResult, ['endSession' => false])
            ->will($this->returnValue($mockedSendResult));
        $mockSessionHandler
            ->expects($this->never())
            ->method('getLastResponse');
    ...
    public function testCanDoTicketDisplayTSMP()
    {
        ...
        $mockSessionHandler
            ->expects($this->once())
            ->method('sendMessage')
            ->with('Ticket_DisplayTSMP', $expectedMessageResult, ['endSession' => false])
            ->will($this->returnValue($mockedSendResult));
        $mockSessionHandler
            ->expects($this->never())
            ->method('getLastResponse');
    ...
    public function testCanDoTicketDisplayTSMFareElement()
    {
        ...
        $mockSessionHandler
            ->expects($this->once())
            ->method('sendMessage')
            ->with('Ticket_DisplayTSMFareElement', $expectedMessageResult, ['endSession' => false])
            ->will($this->returnValue($mockedSendResult));
        $mockSessionHandler
            ->expects($this->never())
            ->method('getLastResponse');
