...
/**
 * ReferenceDetailsTest
 *
 * @package Test\Amadeus\Client\Struct\GetFareFamilyDescription
 */
class ReferenceDetailsTest extends BaseTestCase
{
    public function testCreating()
    {
        $type = 'TA';
        $value = 'B';
        $refDetail = new ReferenceDetails($type, $value);

        self::assertEquals($type, $refDetail->type);
        self::assertEquals($value, $refDetail->value);
    }
