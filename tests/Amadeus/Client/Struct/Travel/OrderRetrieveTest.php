...
use Amadeus\Client\Struct\Travel\OrderRetrieve;
 ...
 */
class OrderRetrieveTest extends BaseTestCase
{
    public function testCanMakeOrderRetrieve()
    {
        ...
        $this->assertEquals('AA12345', $message->Request->OrderFilterCriteria->Order->OrderID);
        $this->assertEquals('AA', $message->Request->OrderFilterCriteria->Order->OwnerCode);
    }
}
