...
/**
 * HandlerListVirtualCardsTest
 *
 * @package Test\Amadeus\Client\ResponseHandler\PAY
 * @author Artem Zakharchenko <artz.relax@gmail.com>
 */
class HandlerListVirtualCardsTest extends BaseTestCase
{
    public function testCanRecognizeErrors(): void
    {
        $handler = new HandlerListVirtualCards();

        $sendResult = new SendResult();
        $sendResult->responseXml = $this->getTestFile('PayListVirtualCardsErrorRS.xml');
