...
/**
 * TicketCancelDocumentConv Request converter
 *
 * @package Amadeus\Client\RequestCreator\Converter\Ticket
 * @author Dieter Devlieghere <dieter.devlieghere@benelux.amadeus.com>
 */
class TicketCancelDocumentConv extends BaseConverter
{
    /**
     * @param TicketCancelDocumentConv $requestOptions
     * @param int|string $version
     * @return Struct\Ticket\CreateTSTFromPricing
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\Ticket\TicketCancelDocument($requestOptions);
    }
}
