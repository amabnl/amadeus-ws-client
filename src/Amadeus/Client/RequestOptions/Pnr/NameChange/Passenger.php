...
{
    /**
     * Traveller Tattoo Number of traveller to change
     *
     * @var int
     */
    public $reference;
    ...
    /**
     * Passenger title (Mr, Ms, Mrs, ...)
     *
     * If you want to remove the previously stored title, enter the value '0'.
     *
     * @var string|int
     */
    public $title;
