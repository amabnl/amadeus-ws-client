...
namespace Amadeus\Client\RequestCreator\Converter\PointOfRef;
...
{
    /**
     * @param PointOfRefSearchOptions $requestOptions
     * @param int|string $version
     * @return Struct\PointOfRef\Search
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\PointOfRef\Search($requestOptions);
    }
}
