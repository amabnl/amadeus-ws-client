...
/**
 * Queue_PlacePNR Request converter
 *
 * @package Amadeus\Client\RequestCreator\Converter\Queue
 * @author Dieter Devlieghere <dermikagh@gmail.com>
 */
class PlacePNRConv extends BaseConverter
{
    /**
     * @param QueuePlacePnrOptions $requestOptions
     * @param int|string $version
     * @return Struct\Queue\PlacePnr
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\Queue\PlacePnr(
            $requestOptions->recordLocator,
            $requestOptions->sourceOfficeId,
            $requestOptions->targetQueue
        );
    }
}
