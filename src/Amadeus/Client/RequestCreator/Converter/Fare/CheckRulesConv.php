...
/**
 * Fare_CheckRules Request converter
 *
 * @package Amadeus\Client\RequestCreator\Converter\Fare
 * @author Dieter Devlieghere <dermikagh@gmail.com>
 */
class CheckRulesConv extends BaseConverter
{
    /**
     * @param FareCheckRulesOptions $requestOptions
     * @param int|string $version
     * @return Struct\Fare\CheckRules
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\Fare\CheckRules($requestOptions);
    }
}
