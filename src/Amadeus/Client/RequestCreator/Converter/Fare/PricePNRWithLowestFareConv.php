...
/**
 * Fare_PricePNRWithLowestFare Request converter
 *
 * @package Amadeus\Client\RequestCreator\Converter\Fare
 * @author Dieter Devlieghere <dermikagh@gmail.com>
 */
class PricePNRWithLowestFareConv extends BaseConverter
{
    /**
     * @param FarePricePnrWithLowestFareOptions $requestOptions
    ...
    public function convert($requestOptions, $version)
    {
        if (floatval($version) < floatval(13)) {
            return new Struct\Fare\PricePNRWithLowestFare12($requestOptions);
        } else {
            return new Struct\Fare\PricePNRWithLowestFare13($requestOptions);
        }
    }
}
