...
/**
 * Service_IntegratedCatalogue Request converter
 *
 * @package Amadeus\Client\RequestCreator\Converter\Service
 * @author Dieter Devlieghere <dermikagh@gmail.com>
 */
class IntegratedCatalogueConv extends BaseConverter
{
    /**
     * @param ServiceIntegratedCatalogueOptions $requestOptions
     * @param int|string $version
     * @return Struct\Service\IntegratedCatalogue
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\Service\IntegratedCatalogue($requestOptions);
    }
}
