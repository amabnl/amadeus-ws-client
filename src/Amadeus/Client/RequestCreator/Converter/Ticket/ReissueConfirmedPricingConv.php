...
{
    /**
     * @param TicketReissueConfirmedPricingOptions $requestOptions
     * @param int|string $version
     * @return Struct\Ticket\ReissueConfirmedPricing
     */
    public function convert($requestOptions, $version)
    {
        return new Struct\Ticket\ReissueConfirmedPricing($requestOptions);
    }
}
