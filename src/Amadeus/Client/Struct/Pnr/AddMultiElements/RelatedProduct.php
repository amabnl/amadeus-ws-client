...
class RelatedProduct
{
     ...
     * LK	Guaranteed sell - Generated automatically by reservation system as a result of an interactive session or when space has been sold from a direct access availability
     * LL	Please waitlist
     * NA	Next Available – Need the segment specified or the alternative segment immediately following. Confirm the specified segment if available and take no action on the alternative. If not available, reply with the appropriate action code and act upon the alternatives in the same manner
