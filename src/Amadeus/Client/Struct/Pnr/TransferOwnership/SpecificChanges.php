 ...
 */
class SpecificChanges
{
    const ACTION_OPT_QUEUE_ELEMENT = "OQ";
    const ACTION_QUEUEING_OFFICE = "QO";
    const ACTION_TICKETING_OFFICE = "TO";
    ...
    /**
     * SpecificChanges constructor.
     *
     * @param string $actionRequestCode self::ACTION_*
     */
