...
class BoardingPriority
{
    ...
    /**
     * BoardingPriority constructor.
     *
     * @param string $boardingPriority
     */
    public function __construct($boardingPriority)
    {
        $this->priorityDetails = new PriorityDetails($boardingPriority);
    }
}
