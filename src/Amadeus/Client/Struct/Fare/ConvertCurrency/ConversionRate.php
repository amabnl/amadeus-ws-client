...
{
    /**
     * @var ConversionRateDetails
     */
    public $conversionRateDetails;

    /**
     * ConversionRate constructor.
     *
     * @param string $conversionType ConversionRateDetails::RATE_TYPE_*
     * @param double|null $amount
     */
    public function __construct($conversionType, $amount = null)
    {
        $this->conversionRateDetails = new ConversionRateDetails($conversionType, $amount);
    }
}
